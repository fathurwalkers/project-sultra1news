...
<body>
        ...
        <ul class="navbar-nav navbar-right">
          ...
          <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
            ...
            <div class="dropdown-menu dropdown-menu-right">
              ...
              <div class="container">
                <div class="row">
                  <div class="col-sm-12 col-lg-12 py-2 px-4">
                    <form action="{{ route('logout') }}" method="POST">
                      @csrf
                      <button type="submit" class="btn btn-danger text-white dropdown-item has-icon text-danger">
                        <center>
                          {{-- <i class="fas fa-sign-out-alt"></i>  --}}
                          <span class="font-weight-1000">LOGOUT</span>
                        </center>
                      </button>
                    </form>
                  </div>
          ...
          <ul class="sidebar-menu">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li><a class="nav-link" href="{{ route('add-post') }}">Tambah Post</a></li>
                </ul>
              </li>
            </ul>
  ...
  {{-- <script src="{{ asset('assets/stisla/assets/js/page/forms-advanced-forms.js') }}"></script> --}}
